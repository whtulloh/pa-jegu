...
class Upload extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->setPath_img_upload_folder("asset/img/articles/");
		$this->setPath_img_thumb_upload_folder("asset/img/articles/thumbnails/");

		//Delete img url
		$this->setDelete_img_url(base_url() . 'asset/img/deleteImage/');

		//Set url img with Base_url()
		$this->setPath_url_img_upload_folder(base_url() . "asset/img/articles/");
		$this->setPath_url_img_thumb_upload_folder(base_url() . "asset/img/articles/thumbnails/");
	}

	public function index()
	{
		$this->load->view('mimin/ajax_upload');
	}
