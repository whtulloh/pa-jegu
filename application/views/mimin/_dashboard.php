			...
			<div class="row-fluid">
				<a data-rel="tooltip" title="6 member baru." class="well span3 top-block" href="<?php echo base_url('mimin/member'); ?>">
				...
				<a data-rel="tooltip" title="4 testimoni baru." class="well span3 top-block" href="#">
				...
				<a data-rel="tooltip" title="Rp 540.000 penjualan baru." class="well span3 top-block" href="#">
					<span class="icon32 icon-color icon-cart"></span>
					<div>Penjualan</div>
					<div>Rp 5.450.000,00</div>
					<span class="notification yellow">Rp 540.000</span>
				</a>
				
				<a data-rel="tooltip" title="12 pesan baru." class="well span3 top-block" href="#">
			...
			<div class="row-fluid">
				<div class="box">
					<div class="box-header well">
						<h2><i class="icon-list-alt"></i> Grafik Penjualan </h2>
						<div class="box-icon">
