...
/** FOR COCO BEAN BAGS DEVELOPER
* Salt diaktifkan
* Activation Code diaktifkan
* Track Login Attempts diakifkan
**/
/*
| -------------------------------------------------------------------------
| Database Type
...
/*
 ...
 | -------------------------------------------------------------------------
 */
$config['message_start_delimiter'] = '<section class="alert alert-success">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</section>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<section class="alert alert-error">';		// Error mesage start delimiter
$config['error_end_delimiter']     = '</section>';	// Error mesage end delimiter
